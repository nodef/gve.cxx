...
EXPORT namespace gve {
  // Methods
  // using detail::pagerankPruneUpdateRank;
  // using detail::pagerankPruneUpdateRanks;
  // using detail::pagerankPruneUpdateRanksAsync;
  // using detail::pagerankPruneInvoke;
  using detail::pagerankPruneDynamicFrontier;
#ifdef _OPENMP
  // using detail::pagerankPruneUpdateRanksOmp;
  // using detail::pagerankPruneUpdateRanksAsyncOmp;
  // using detail::pagerankPruneInvokeOmp;
  using detail::pagerankPruneDynamicFrontierOmp;
#endif
} // namespace gve
