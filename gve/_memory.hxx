...
EXPORT namespace gve {
  // Classes
  using detail::FixedArenaAllocator;
  using detail::ArenaAllocator;
  using detail::Pow2Allocator;
  using detail::ConcurrentPow2Allocator;

  // Methods
  using detail::bytesof;
  using detail::allocateValues;
  using detail::reallocateValues;

#ifdef _OPENMP
  using detail::allocateValuesOmp;
  using detail::reallocateValuesOmp;
#endif
} // namespace gve
