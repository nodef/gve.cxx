...
struct PagerankResult {
   ...
   */
  PagerankResult(vector<V>& ranks, int iterations=0, float time=0, float initializationTime=0, float markingTime=0, float computationTime=0) :
  ranks(std::move(ranks)), iterations(iterations), time(time), initializationTime(initializationTime), markingTime(markingTime), computationTime(computationTime) {}
  #pragma endregion
};
#pragma endregion
...
EXPORT namespace gve {
  // Types
  using detail::PagerankOptions;
  using detail::PagerankResult;
  // Methods
  // using detail::pagerankUpdateRank;
  // using detail::pagerankUpdateRanks;
  // using detail::pagerankUpdateRanksAsync;
  // using detail::pagerankInitializeRanks;
  // using detail::pagerankInitializeRanksFrom;
  // using detail::pagerankInvoke;
  using detail::pagerankStatic;
  using detail::pagerankNaiveDynamic;
  // using detail::pagerankAffectedTraversalW;
  using detail::pagerankDynamicTraversal;
  // using detail::pagerankAffectedFrontierW;
  using detail::pagerankDynamicFrontier;
#ifdef _OPENMP
  // using detail::pagerankUpdateRanksOmp;
  // using detail::pagerankUpdateRanksAsyncOmp;
  // using detail::pagerankInitializeRanksOmp;
  // using detail::pagerankInitializeRanksFromOmp;
  // using detail::pagerankInvokeOmp;
  using detail::pagerankStaticOmp;
  using detail::pagerankNaiveDynamicOmp;
  // using detail::pagerankAffectedTraversalOmpW;
  using detail::pagerankDynamicTraversalOmp;
  // using detail::pagerankAffectedFrontierOmpW;
  using detail::pagerankDynamicFrontierOmp;
#endif
} // namespace gve
