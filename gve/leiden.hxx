...
EXPORT namespace gve {
  // Types
  using detail::LeidenOptions;
  using detail::LeidenResult;
  // Methods
  // using detail::leidenAllocateHashtablesW;
  // using detail::leidenFreeHashtablesW;
  // using detail::leidenVertexWeightsW;
  // using detail::leidenCommunityWeightsW;
  // using detail::leidenInitializeW;
  // using detail::leidenInitializeFromW;
  // using detail::leidenUpdateWeightsFromU;
  // using detail::leidenScanCommunityW;
  // using detail::leidenScanCommunitiesW;
  // using detail::leidenClearScanW;
  // using detail::leidenChooseCommunity;
  // using detail::leidenChangeCommunityW;
  // using detail::leidenMoveW;
  // using detail::leidenCommunityExistsW;
  // using detail::leidenCommunityTotalDegreeW;
  // using detail::leidenCountCommunityVerticesW;
  // using detail::leidenCommunityVerticesW;
  // using detail::leidenLookupCommunitiesU;
  // using detail::leidenAggregateEdgesW;
  // using detail::leidenRenumberCommunitiesW;
  // using detail::leidenAggregateW;
  // using detail::leidenInvoke;
  // using detail::leidenSetupInitialsW;
  using detail::leidenStatic;
#ifdef _OPENMP
  // using detail::leidenVertexWeightsOmpW;
  // using detail::leidenCommunityWeightsOmpW;
  // using detail::leidenInitializeOmpW;
  // using detail::leidenInitializeFromOmpW;
  // using detail::leidenUpdateWeightsFromOmpU;
  // using detail::leidenChangeCommunityOmpW;
  // using detail::leidenMoveOmpW;
  // using detail::leidenCommunityExistsOmpW;
  // using detail::leidenCommunityTotalDegreeOmpW;
  // using detail::leidenCountCommunityVerticesOmpW;
  // using detail::leidenCommunityVerticesOmpW;
  // using detail::leidenLookupCommunitiesOmpU;
  // using detail::leidenAggregateEdgesOmpW;
  // using detail::leidenRenumberCommunitiesOmpW;
  // using detail::leidenAggregateOmpW;
  // using detail::leidenInvokeOmp;
  using detail::leidenStaticOmp;
#endif
} // namespace gve
